...
float Ultrasonic::findFrontLeftDistance()
{
...
float Ultrasonic::findBackLeftDistance()
{
...
float Ultrasonic::findTopLeftDistance()
{
...
float Ultrasonic::findFrontRightDistance()
{
...
float Ultrasonic::findBackRightDistance()
{
...
float Ultrasonic::findBottomRightDistance()
{
