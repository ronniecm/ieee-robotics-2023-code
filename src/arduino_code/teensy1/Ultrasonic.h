...
#define Ultra4_trigPin 19
#define Ultra4_echoPin 18

#define Ultra5_trigPin 17
#define Ultra5_echoPin 16
...
private:
    ...
    uint8_t trigPins[6] = {23, 21, 19, 17, 41, 39};
    uint8_t echoPins[6] = {22, 20, 18, 16, 40, 38};
